...
export async function sendFreeEmail(env, { name, email, type, triage, stripeLink, stage = 1 }) {
  ...
  if (stageNumber === 1) {
    ...
    await sendEmail(env, {
      to: email,
      subject: `Before you pay this — read this first`,
      html: `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;color:#1f2937;line-height:1.7;">
        ...
        <p>If you want to know exactly what to do next, you can get a full analysis and a ready-to-send response letter:</p>
  ...
  if (stageNumber === 2) {
    await sendEmail(env, {
      ...
      html: `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;color:#1f2937;line-height:1.7;">
        ...
        <p style="font-size:0.9rem;color:#374151;">
          A short check now can save you money — and stress — later.
        </p>
  ...
  await sendEmail(env, {
    ...
    html: `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;color:#1f2937;line-height:1.7;">
      ...
      <p style="font-size:0.9rem;color:#374151;">
        This takes just a few minutes — and gives you clarity before you decide.
      </p>
  ...
  await trackEvent(env, "email_sent", { type, stage: 3, kind: "free" });
}
  ...
  await sendEmail(env, {
    ...
    html: `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;color:#1f2937;line-height:1.7;">
      ...
      <p style="background:#f0fdf4;border-left:4px solid #22c55e;padding:12px;border-radius:4px;font-size:0.9rem;">
        💡 Tip: Send the letter by recorded post and keep proof of postage.
      </p>
